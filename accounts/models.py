...
class UserProfile(Model):
    user = OneToOneField(settings.AUTH_USER_MODEL, related_name='profile')
    following = ManyToManyField(settings.AUTH_USER_MODEL, blank=True, related_name='followers')

    objects = UserProfileManager()

    def __str__(self):
        return "%s" % self.following.all().count()
